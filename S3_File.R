...
# rows with na's between 1st and last qustion dropped
...
# 2-Way Cross Tabulation
  ...
  CrossTable(testdat3$met_feed, testdat3$FOR2) # might be too low (count 26 in one group) , FOR1 would be a potential alternative 
  CrossTable(testdat3$met_feed, testdat3$soakhay) # might be too low (count 27 in one group)
  
  CrossTable(testdat3$met_feed, testdat3$EXER1) # might be too low (count 25 in one group)
